...
export function OurApp() {
  ...
  const imageX = useTransform(scrollYProgress, [0, 1], isMobile ? [0, 0] : [50, -50]);
  const contentX = useTransform(scrollYProgress, [0, 1], isMobile ? [0, 0] : [-50, 50]);
  const decorationScale = useTransform(scrollYProgress, [0, 0.5, 1], isMobile ? [1, 1, 1] : [0.8, 1.2, 0.9]);
  const decorationRotate = useTransform(scrollYProgress, [0, 1], isMobile ? [0, 0] : [0, 15]);
  const waveY = useTransform(scrollYProgress, [0, 1], isMobile ? [0, 0] : [0, -50]);
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative">
        <div className={`grid grid-cols-1 ${isMobile ? "" : "lg:grid-cols-2"} gap-8 lg:gap-16 items-center`}>
