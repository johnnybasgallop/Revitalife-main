            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center h-full">
              ...
              <div>
                ...
                <ScrollReveal variant="fadeInRight" delay={0.4} duration={0.8}>
                  <div className="flex items-center mb-10">
                    ...
                    <div className="flex items-center border border-gray-300 rounded-md">
                      <button className="px-4 py-2 text-gray-500 hover:text-gray-700">-</button>
                      <span className="px-5 py-2 border-l border-r border-gray-300">1</span>
                      <button className="px-4 py-2 text-gray-500 hover:text-gray-700">+</button>
                    </div>
                  </div>
                </ScrollReveal>
                ...
                <ScrollReveal variant="fadeInRight" delay={0.5} duration={0.8}>
                  <Button size="lg" className="w-full md:w-auto text-lg py-3 px-8">
                    Add to Cart
                  </Button>
                </ScrollReveal>
              </div>
